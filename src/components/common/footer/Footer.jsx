...
const Footer = () => {
  ...
  return (
    <div className="bg-[#2A374A] p-4 mt-4 h-[320px] flex justify-between relative">
      <div className="flex justify-between mx-0 lg:px-[15%] items-center h-full w-full text-neutral-200 lg:bg-red-700 md:bg-amber-100 absolute">
        ...
        <div className="mx-3 flex lg:bg-red-300 flex-wrap">
          {navItems.map((item) => (
            <a
              key={item.id}
